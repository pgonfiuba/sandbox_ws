# Lanza el ejemplo C++ `hello_moveit_obstacles` con los parámetros de MoveIt cargados.
#
...
#   Terminal 2:  ros2 launch clase7 hello_moveit_obstacles.launch.py
...
def generate_launch_description():
    ...
    hello_moveit_obstacles_node = Node(
        package='clase7',
        executable='hello_moveit_obstacles',
        output='screen',
        parameters=[
